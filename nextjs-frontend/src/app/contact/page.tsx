  ...
  return (
    <MainLayout>
      <div className="min-h-screen bg-white">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-primary-600 to-blue-700 text-white py-16 relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="text-right">
                    <button
                      ...
                      className="inline-flex items-center px-6 py-3 bg-primary-600 text-white font-medium rounded-md hover:bg-primary-700 transition-colors disabled:opacity-50"
                    >
