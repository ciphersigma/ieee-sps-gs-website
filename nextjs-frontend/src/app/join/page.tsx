...
import { Users, Award, BookOpen, Globe, DollarSign } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-primary-50 rounded-lg p-8 mb-16">
            ...
            <p className="text-gray-700 text-lg">
              If you're a student looking to learn more about signal processing and careers within the field, a student membership with SPS offers unique benefits, including opportunities for career development, student-focused competitions, and travel grants to attend SPS flagship conferences.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-primary-600 to-blue-700 rounded-lg p-8 text-center text-white">
