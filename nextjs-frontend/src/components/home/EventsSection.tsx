      ...
      <section id="events" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <Link href="/events" className="inline-flex items-center px-5 py-2 bg-primary-500 text-white rounded-md hover:bg-primary-600 transition-colors">
    ...
    <section id="events" className="py-12 sm:py-16 lg:py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-12">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4 relative inline-block">
              Upcoming Events
              <span className="absolute bottom-0 left-0 w-full h-1 bg-primary-500 transform translate-y-2"></span>
            </h2>
          ...
          <Link 
            href="/events" 
            className="mt-4 md:mt-0 inline-flex items-center text-primary-500 hover:text-primary-600 font-medium transition-colors text-sm sm:text-base"
          >
        ...
        <div className="text-center mt-8 sm:mt-12">
          <Link 
            href="/events" 
            className="inline-flex items-center px-5 sm:px-6 py-2.5 sm:py-3 bg-primary-500 text-white rounded-md hover:bg-primary-600 transition-colors text-sm sm:text-base"
          >
