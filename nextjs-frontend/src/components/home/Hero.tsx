...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      const blueWavePoints: Array<{ x: number; y: number }> = [];
      ...
      const greenWavePoints: Array<{ x: number; y: number }> = [];
      for (let x = 0; x < dimensions.width; x += 5) {
      ...
      const signalPoints: Array<{ x: number; y: number; color: string }> = [];
  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-ieee-blue via-ieee-light-blue to-ieee-navy"></div>
      ...
      {/* Content */}
      <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-8 sm:py-12">
        ...
        <p className="text-lg sm:text-xl lg:text-2xl text-white mb-8 sm:mb-12 max-w-3xl mx-auto px-2">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
          <Link 
            href="/events" 
            className="inline-flex items-center px-5 sm:px-6 py-2.5 sm:py-3 bg-white text-gray-800 rounded-md hover:bg-gray-100 transition-colors font-medium text-sm sm:text-base"
          >
          ...
          <Link 
            href="/join" 
            className="inline-flex items-center px-5 sm:px-6 py-2.5 sm:py-3 border-2 border-white text-white rounded-md hover:bg-white/10 transition-colors font-medium text-sm sm:text-base"
          >
            Join Our Community
