...
const EventDetailPage = () => {
  ...
  const fetchRelatedEvents = async () => {
    try {
      ...
      const filtered = (data || []).filter(event => event._id !== id).slice(0, 3);
  ...
  const getEventStatus = () => {
    ...
    return event.event_date >= today ? 'Upcoming' : 'Past Event';
  };
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center text-xs text-primary-600 mb-2">
                      ...
                      <span>{formatShortDate(relatedEvent.event_date)}</span>
                    </div>
